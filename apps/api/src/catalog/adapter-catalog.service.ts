...
export class AdapterCatalogService {
  ...
  private readonly fallbackCatalog: AdapterCatalogEntry[] = [
    ...
    },
    {
      ...
      category: 'dynamic',
      description: 'Run dynamic apps on Cloudflare workers with secure sandboxing.',
      features: ['Edge compute', 'Runtime environments', 'Secure isolation'],
      docsUrl: 'https://github.com/kagehq/brail/blob/main/docs/PLATFORMS.md#cloudflare-sandbox-adapter',
      supportsPreview: true,
      supportsProduction: true,
    },
    {
      ...
      category: 'dynamic',
      description: 'Provision fully isolated Vercel sandboxes with advanced observability.',
      features: ['Node and Python runtimes', 'Custom resources'],
      docsUrl: 'https://github.com/kagehq/brail/blob/main/docs/PLATFORMS.md#vercel-sandbox-adapter',
      supportsPreview: true,
      supportsProduction: true,
    },
  ];
